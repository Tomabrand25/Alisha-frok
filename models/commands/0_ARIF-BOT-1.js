...
if ((event.body.toLowerCase() == "iam back") || (event.body.toLowerCase() == "am back")) {
  ...
  if ((event.body.toLowerCase() == "shan") || (event.body.toLowerCase() == "Shaan")) {
     return api.sendMessage("BOSS BUSY HAI YAR 🤨🤨", threadID);
   };
if ((event.body.toLowerCase() == "tharki bot") || (event.body.toLowerCase() == "tharki")) {
     return api.sendMessage("𝐓𝐔 𝐓𝐇𝐀𝐑𝐊𝐈 𝐓𝐄𝐑𝐈 𝐆𝐅 𝐓𝐇𝐀𝐑𝐊𝐈 𝐓𝐄𝐑𝐄 𝐀𝐀𝐍𝐄 𝐖𝐀𝐋𝐄 𝐁𝐀𝐂𝐇𝐇𝐄 𝐓𝐇𝐀𝐑𝐊𝐈  😏😏😼😼😼", threadID);
   };
  
   if ((event.body.toLowerCase() == "🙄") || (event.body.toLowerCase() == "🙄🙄")) {
     return api.sendMessage("uper kiya kia hai amma ne chapal mara kia 🙄😈", threadID);
   };

if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "shaan")) {
     return api.sendMessage("✫𝘽𝙤𝙩 𝙊𝙬𝙣𝙚𝙧🌼 ko mention na karo wo busy hai jo kaam hai mujhe batao", threadID);
   };

if ((event.body.toLowerCase() == "😎") || (event.body.toLowerCase() == "😎😎")) {
     return api.sendMessage("chashma hatawo na Sir kya Name Apka 😎😎", threadID);
   };
 ...
 if ((event.body.toLowerCase() == "💀") || (event.body.toLowerCase() == "👻")) {
     return api.sendMessage("𝐘𝐄 𝐃𝐄𝐊𝐇 𝐆𝐀𝐑𝐄𝐁𝐎 𝐊𝐈 𝐁𝐇𝐎𝐓𝐇😁😁", threadID);
   };
